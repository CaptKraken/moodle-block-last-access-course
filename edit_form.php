    ...
    protected function specific_definition($mform)
    {
        ...
        function color_picker_generator($id, $defaultClr)
        {
            ...
            window.addEventListener('DOMContentLoaded',()=>{
                ...
                const {$id}Picker = `<div style='display: flex; align-items: center;'><input type='color' id='id_config_input_{$id}_picker'><p id='btn_{$id}_reset' class='btn-reset-clr'>Reset Color</p></div>`;
        ...
        $mform->setDefault('config_thumb_color', '#00000');
